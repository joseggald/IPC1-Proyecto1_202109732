...
public class RevistasBiblio {
    ...
    public RevistasBiblio(String cod, String autor, int año, String titulo, int edicion, String desc, String cate, String temas, int ejemplares, int copias, int disp, String palabras,Button btnPrestar) {
        ...
        this.btnPrestar.setText("Prestar");
    }
