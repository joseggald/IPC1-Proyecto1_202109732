...
public class TesisBiblioDev {
    ...
    public TesisBiblioDev(String cod , String autor, int año, String titulo, int edicion, String desc, String temas, String areas, int copias, int disp, String palabras, Button btnPrestar) {
