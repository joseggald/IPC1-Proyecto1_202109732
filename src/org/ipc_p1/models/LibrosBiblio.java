...
public class LibrosBiblio {
    ...
    public LibrosBiblio(String aut, int año, String titulo, int edicion, int isbn, String palabras, String desc, String temas, int copias, int disp, Button btnPrestar) {
